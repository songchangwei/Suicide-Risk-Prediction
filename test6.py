...
import pandas as pd
from model5 import LSTMModel,GRUModel,BiLSTMModel,BiGRUModel
from model3 import TransformerClassifier
from model6 import MambaClassifier
...
#model = BiGRUModel(input_dim, hidden_dim, output_dim, num_layers)
...
model.load_state_dict(torch.load('MambaClassifier/model_weight_4.pth'))
...
with torch.no_grad():
        ...
        df.to_csv('MambaClassifier/probalility_4.csv',index=False)
