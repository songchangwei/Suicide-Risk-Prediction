...
#model = BiGRUModel(input_dim, hidden_dim, output_dim, num_layers).to(device)
...
for epoch in range(num_epochs):
    ...
    with torch.no_grad():
        ...
        if best_f1 < f1:
            ...
            best_f1 = f1
            torch.save(model.state_dict(), 'TransformerClassifier/model_weight_5.pth')
