...
from multitask_base_model2 import Mutiltask_base2
...
model = Mutiltask_base2(input_size, hidden_size, output_size1,output_size2).to(device)
...
for epoch in range(num_epochs):
    ...
    with torch.no_grad():
        ...
        if best_f1 < f1:
            ...
            best_f1 = f1
            torch.save(model.state_dict(), 'Mutiltask_base2/model_weight_5.pth')
