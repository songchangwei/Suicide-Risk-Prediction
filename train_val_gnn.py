...
model = WiKG(dim_in=1280, dim_hidden=1280, topk=32, n_classes=1, agg_type='bi-interaction', dropout=0.3, pool='mean').to(device)
...
for epoch in range(num_epochs):
    ...
    with torch.no_grad():
        ...
        if best_f1 < f1:
            ...
            best_f1 = f1
            torch.save(model.state_dict(), 'GNN/model_weight_5.pth')
